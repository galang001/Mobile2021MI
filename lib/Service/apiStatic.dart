...
class ApiStatic {
  static var _token = "19|XfAVTZhhu5oPfepAUQIDAvc1Lisa3xjWfUXnmwVS";
  ...
  static Future<List<Brand>> getBrandHP() async {
    // String response =
    //     '{"data":[{"IDphone":3,"nama":"X3 GT","kdphone":"2021","merk":"Xiaomi","asalhp":null,"foto":null,"created_at":"2021-09-25T13:53:19.000000Z","updated_at":"2021-09-25T13:53:19.000000Z"}]}';
    try {
      final response = await http.get(
  ...
  static Future<ErrorMSG> deletePhone(id) async {
    try {
  ...
  static Future<ErrorMSG> sigIn(_post) async {
    try {
      ...
      ErrorMSG responseRequest =
          ErrorMSG(success: false, message: 'error cauddght: $e');
      return responseRequest;
    }
  }
}
